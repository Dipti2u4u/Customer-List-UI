const firstNames = [
  "Aarav","Vivaan","Aditya","Vihaan","Arjun","Kabir","Ishaan","Ananya","Aditi","Diya",
  "Rohan","Karan","Sneha","Deepa","Pooja","Vikram","Riya","Sanjay","Priya","Kavya"
];
const lastNames = [
  "Sharma","Verma","Gupta","Patel","Sinha","Reddy","Nair","Das","Khan","Singh",
  "Kapoor","Mehta","Chaudhary","Ghosh","Bose","Kaur"
];
...
export function generateData(total = 1000) {
